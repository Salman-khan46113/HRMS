                            ...
                            <div class="row mb-3">
                                <div class="col-6 form-input-box">
                                    ...
                                    <div class="input-group select-box">
                                        <select class="form-select form-control" name="company_id" id="company_id" {if $mode eq 'Update'}disabled{/if}>
                                ...
                                <div class="col-6 form-input-box">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control number-formatter"  id="ctc_value" name="ctc_value" placeholder="Enter CTC" value="{getNumberFormate($ctc_value)}" />
                                    </div>
                                </div>
                            </div>
                            <div class="column-view-parent form-row row-fluid tab-focus-child">
