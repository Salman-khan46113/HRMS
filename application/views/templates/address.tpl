...
<div class=" address-sub-block form-contain border border-primary rounded-2 border border-2 p-3">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" class="form-control" id="bank_name_{{$index}}" name="bank_name[{$index}]" placeholder="Please enter Bank Name">
        </div>
        <div class="col">
            <label for="bank_address" class="form-label">Bank Address <span class="star_required">*</span></label>
            <input type="text" class="form-control" id="bank_address_{{$index}}" name="bank_address[{$index}]" placeholder="Please enter Bank Address">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" class="form-control" id="ifsc_code_{{$index}}" name="ifsc_code[{$index}]" placeholder="Please enter IFSC code">
        </div>
        <div class="col">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" class="form-control" id="acc_numner_{{$index}}" name="acc_numner[{$index}]" placeholder="Please enter Account number">
        </div>
        <div class="col">
            <label for="acc_holder" class="form-label">Account Holder Name <span class="star_required">*</span></label>
            <input type="text" class="form-control" id="acc_holder_{{$index}}" name="acc_holder[{$index}]" placeholder="Pan Number">
...
<div class="address-sub-block form-contain border border-primary rounded-2 border border-2 p-3">
    ...
    <div class="row mb-3">
        <div class="col">
            <label for="bank_name" class="form-label">Bank Name <span class="star_required">*</span></label>
            <input type="text" class="form-control" id="bank_name_{{$index}}" name="bank_name[{$index}]" placeholder="Please enter Bank Name" value="{$item_val['bank_name']}">
        </div>
        <div class="col">
            <label for="bank_address" class="form-label">Bank Address  <span class="star_required">*</span></label>
            <input type="text" class="form-control" id="bank_address_{{$index}}" name="bank_address[{$index}]" placeholder="Please enter Bank Address" value="{$item_val['branch_address']}">
    ...
    <div class="row mb-3">
        <div class="col">
            <label for="ifsc_code" class="form-label">IFSC Code<span class="star_required">*</span></label>
            <input type="text" class="form-control" id="ifsc_code_{{$index}}" name="ifsc_code[{$index}]" placeholder="Please enter IFSC code" value="{$item_val['ifsc_code']}">
        </div>
        <div class="col">
            <label for="acc_type" class="form-label">Account Type <span class="star_required">*</span></label>
            <select class="form-select form-control" name="acc_type[{$index}]" id="acc_type_{{$index}}" >
    ...
    <div class="row mb-3">
        <div class="col">
            <label for="acc_numner" class="form-label">Account Number <span class="star_required">*</span></label>
            <input type="text" class="form-control" id="acc_numner_{{$index}}" name="acc_numner[{$index}]" placeholder="Please enter Account number" value="{$item_val['account_no']}">
        </div>
        <div class="col">
            <label for="acc_holder" class="form-label">Account Holder Name <span class="star_required">*</span></label>
            <input type="text" class="form-control" id="acc_holder_{{$index}}" name="acc_holder[{$index}]" placeholder="Pan Number" value="{$item_val['account_holder_name']}">
