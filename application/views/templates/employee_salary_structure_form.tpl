					...
					<div class="title-contain-bloack">
						<div class="row">
								...
								<div class="col-3 mt-2">
									...
									<div class="value-box mt-1"><input type="text" class="form-control number-formatter"  id="ctc_value" name="ctc_value" placeholder="Enter CTC" value="{getNumberFormate($designation_salary_structure['ctc_value'])}" /></div>
								</div>
								<div class="col-3 mt-2">
