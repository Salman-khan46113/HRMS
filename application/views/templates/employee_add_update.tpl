                                            ...
                                            <div class="form-contain">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        ...
                                                        <input type="text" class="form-control" id="first_name" name="first_name" value="{$employee_data['first_name']}" placeholder="First Name" />
                                                    </div>
                                                    <div class="col">
                                                        <label for="middle_name" class="form-label">Middle Name </label>
                                                        <input type="text" class="form-control" id="middle_name" name="middle_name" value="{$employee_data['middle_name']}" placeholder=" Middle Name" />
                                                    </div>
                                                    <div class="col">
                                                        <label for="last_name" class="form-label">Last Name <span class="star_required">*</span></label>
                                                        <input type="text" class="form-control" id="last_name" name="last_name" value="{$employee_data['last_name']}" placeholder="Last Name" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        ...
                                                        <input type="email" class="form-control" id="email" name="email" value="{$employee_data['email']}" placeholder="Email" />
                                                    </div>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col mobile_number">
                                                        <div class="form-group mb-1">
                                                            ...
                                                            <input type="text" class="form-control tel-input" id="mobile_number" name="mobile_number" placeholder="Mobile Number" value="{$employee_data['mobile_number']}"/>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col secondary_number">
                                                        <div class="form-group mb-1">
                                                            ...
                                                            <input type="text" class="form-control tel-input" id="secondary_number" name="secondary_number" placeholder="Secondary Mobile Number" value="{$employee_data['secondary_mobile_number']}" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                ...
                                                <div class="row mb-3">
                                                	<div class="col overtime-allow-box">
                                                        <div class="form-group mb-0">
                                                            ...
                                                            <div class="form-check form-check-inline mt-2">
                                                                <input class="form-check-input form-control" type="radio" name="overtime_allow" id="yes" value="Yes" {{if $employee_data['over_time_allow'] == 'Yes'}} checked {{/if}}/>
                                            ...
                                            <div class="form-contain">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-6">
                                                        ...
                                                        <input type="text" class="form-control" id="city" name="city" placeholder="City" value="{$employee_data['city']}"/>
                                                    </div>
                                                    <div class="col-6">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-6 col">
                                                        ...
                                                        <input type="text" class="form-control" id="zipcode" name="zipcode" placeholder="Zip code"  value="{$employee_data['zipcode']}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3 title-block">
                                            ...
                                            <div class="form-contain">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        ...
                                                        <input type="text" class="form-control" id="aadhar_number" name="aadhar_number" placeholder="Aadhar Number" value="{$employee_data['aadhar_number']}"/>
                                                    </div>
                                                    <div class="col">
                                                        <label for="pan_card_number" class="form-label">PAN Card Number <span class="star_required">*</span></label>
                                                        <input type="text" class="form-control" id="pan_card_number" name="pan_card_number" placeholder="PAN Card Number" value="{$employee_data['pan_card_number']}"/>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="pf_number" class="form-label">PF Number </label>
                                                        <input type="text" class="form-control" id="pf_number" name="pf_number" placeholder="PF Number " value="{$employee_data['pf_number']}"/>
                                                    </div>
                                                    <div class="col">
                                                        <label for="uan_number" class="form-label">UAN Number </label>
                                                        <input type="text" class="form-control" id="uan_number" name="uan_number" placeholder="UAN Number " value="{$employee_data['uan_number']}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3 title-block">
                                            ...
                                            <div class="form-contain">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        ...
                                                        <input type="text" class="form-control" id="degree_name" name="degree_name" placeholder="Degree" value="{$employee_data['education_degree']}"/>
                                                    </div>
                                                    <div class="col">
                                                        <label for="education_field" class="form-label">Field <span class="star_required">*</span></label>
                                                        <input type="text" class="form-control" id="education_field" name="education_field" placeholder="Field" value="{$employee_data['education_feild']}"/>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <label for="college_name" class="form-label">College Name<span class="star_required">*</span></label>
                                                        <input type="text" class="form-control" id="college_name" name="college_name" placeholder="College Name" value="{$employee_data['education_college']}"/>
                                                    </div>
                                                    <div class="col">
                                                        <label for="pass_out_year" class="form-label">Pass Out Year <span class="star_required">*</span></label>
                                                        <input type="number" class="form-control" id="pass_out_year" name="pass_out_year" placeholder="Pass Out Year" value="{$employee_data['education_pass_out_year']}"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
