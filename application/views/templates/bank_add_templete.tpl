...
<div class="form-contain border border-primary rounded-2 border border-2 p-3">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" class="form-control" id="bank_name_{$index}" name="bank_name[{$index}]" placeholder="Bank Name" />
        </div>
        <div class="col">
            <label for="branch_address" class="form-label">Branch Address <span class="star_required">*</span></label>
            <input type="text" class="form-control" id="branch_address_{$index}" name="branch_address[{$index}]" placeholder="Branch Address" />
        </div>
    </div>
    <div class="row mb-3">
        <div class="col">
            <label for="ifsc_code" class="form-label">IFSC Code <span class="star_required">*</span></label>
            <input type="text" class="form-control" id="ifsc_code_{$index}" name="ifsc_code[{$index}]" placeholder="IFSC Code" />
        </div>
        <div class="col">
    ...
    <div class="row mb-3">
        <div class="col">
            ...
            <input type="text" class="form-control" id="account_number_{$index}" name="account_number[{$index}]" placeholder="Account Number" />
        </div>
        <div class="col">
            <label for="account_holder_name" class="form-label">Account Holder Name <span class="star_required">*</span></label>
            <input type="text" class="form-control" id="account_holder_name_{$index}" name="account_holder_name[{$index}]" placeholder="Branch Address" />
        </div>
    </div>
</div>
    ...
    {foreach from=$bank_data key=key_val item=bank_data_val}
        <div class="form-contain border border-primary rounded-2 border border-2 p-3">
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="bank_name" class="form-label">Bank Name<span class="star_required">*</span></label>
                    <input type="text" class="form-control" id="bank_name_{$key_val}" name="bank_name[{$key_val}]" value="{$bank_data_val['bank_name']}" placeholder="Bank Name" />
                </div>
                <div class="col">
                    <label for="branch_address" class="form-label">Branch Address <span class="star_required">*</span></label>
                    <input type="text" class="form-control" id="branch_address_{$key_val}" name="branch_address[{$key_val}]" value="{$bank_data_val['branch_address']}" placeholder="Branch Address" />
                </div>
            </div>
            <div class="row mb-3">
                <div class="col">
                    <label for="ifsc_code" class="form-label">IFSC Code <span class="star_required">*</span></label>
                    <input type="text" class="form-control" id="ifsc_code_{$key_val}" name="ifsc_code[{$key_val}]" value="{$bank_data_val['ifsc_code']}" placeholder="IFSC Code" />
                </div>
                <div class="col">
                    <label for="account_type" class="form-label">Account Type<span class="star_required">*</span></label>
            ...
            <div class="row mb-3">
                <div class="col">
                    <label for="account_number" class="form-label">Account Number<span class="star_required">*</span></label>
                    <input type="text" class="form-control" id="account_number_{$key_val}" name="account_number[{$key_val}]" value="{$bank_data_val['account_no']}" placeholder="Account Number" />
                </div>
                <div class="col">
                    <label for="account_holder_name" class="form-label">Account Holder Name <span class="star_required">*</span></label>
                    <input type="text" class="form-control" id="account_holder_name_{$key_val}" name="account_holder_name[{$key_val}]" value="{$bank_data_val['account_holder_name']}" placeholder="Branch Address" />
                </div>
            </div>
        </div>
    {/foreach}
