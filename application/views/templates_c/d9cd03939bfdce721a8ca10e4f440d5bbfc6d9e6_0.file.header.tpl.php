<?php
/* Smarty version 4.3.2, created on 2024-05-16 12:20:22
  from '/var/www/html/extra_work/HRMS/application/views/templates/header.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_6645acaeec7b57_48417538',
...
function content_6645acaeec7b57_48417538 (Smarty_Internal_Template $_smarty_tpl) {
?><!--  -->
<!doctype html>
<html lang="en">
...
>
  ...
  <!-- chosen  -->
   <?php echo '<script'; ?>
 src="public/js/plugin/chosen/chosen.js"><?php echo '</script'; ?>
>
  <!-- <?php echo '<script'; ?>
...
echo $_smarty_tpl->tpl_vars['user_data']->value['comapany_logo'];
...
echo $_prefixVariable9;?>
           ...
           <?php ob_start();
if ($_smarty_tpl->tpl_vars['user_data']->value['over_time_allow'] == 'No' || in_array($_smarty_tpl->tpl_vars['role']->value,array('admin','arom'))) {
...
echo $_prefixVariable12;?>
              ...
              <?php ob_start();
if ($_smarty_tpl->tpl_vars['user_data']->value['over_time_allow'] == 'No') {
...
echo $_prefixVariable17;?>
            ...
            <?php ob_start();
if ($_smarty_tpl->tpl_vars['config']->value['company_prefix'] != '') {
$_prefixVariable18 = ob_get_clean();
echo $_prefixVariable18;?>

            <li class="sidebar-item">
              <a class="sidebar-link" href="./attendance.html?prefix=<?php echo base64_encode($_smarty_tpl->tpl_vars['config']->value['company_prefix']);?>
" aria-expanded="false">
                <span>
...
echo $_prefixVariable19;?>
            ...
            <?php ob_start();
if (in_array($_smarty_tpl->tpl_vars['role']->value,array('admin'))) {
