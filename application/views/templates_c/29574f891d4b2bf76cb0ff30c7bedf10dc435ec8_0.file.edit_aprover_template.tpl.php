...
function content_663e6f5d6a2830_91486832 (Smarty_Internal_Template $_smarty_tpl) {
                ...
                <div class="row g-0 m-3">
                    ...
                    <div class="col-12 employee-detils">
                        <div class="row">
                            ...
                            <?php ob_start();
if ($_smarty_tpl->tpl_vars['data']->value['new_employe_data']['overtime_allow'] == 'Yes') {
$_prefixVariable3 = ob_get_clean();
echo $_prefixVariable3;?>

                            <div class="col-3 p-1 to-date-block">
                                <span class="title-box">Overtime Rate (Per Hour) </span>
                                <span class="val-box"><?php echo getNumberFormate($_smarty_tpl->tpl_vars['data']->value['new_employe_data']['overtime_rate_per_hour']);?>
</span>
                            </div>
                            <?php ob_start();
}
