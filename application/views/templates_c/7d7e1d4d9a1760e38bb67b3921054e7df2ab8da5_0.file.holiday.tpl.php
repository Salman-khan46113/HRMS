...
function content_664592902a2fc8_18473962 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
echo $_prefixVariable1;?>
    ...
    <div class="timesheet-container">
        <div class="custom-modal-content custom-content-table-with-fixed-column holiday-list-body <?php if (!(count($_smarty_tpl->tpl_vars['holiday_data']->value) > 0)) {?>no-table-box-effect<?php }?>">
...
public/assets/images/images/no_holiday_found.png" height="100" width="100" class="mt-5 mb-3 no-holiday-img">
								<br>
